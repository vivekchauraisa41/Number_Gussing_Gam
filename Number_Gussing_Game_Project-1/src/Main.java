...
public class Main {
    ...
    public static void menu(ArrayList<Integer> scoreBoard) {
        ...
        try{
        System.out.print("Select one above");
        int menuOption = input.nextInt();

        switch (menuOption) {
            case 1:
                System.out.print("\n" + "What would you like the range of game? ");
    ...
    public void guessNumber(int randomNumber) {
        ...
        if(guess < 5) {
            ...
            System.out.println("Score is 800");
        }
        else if (guess < 15) {
            System.out.println("Score is 600");
        }
        else if (guess < 20) {
            System.out.println("Score is 400");
        }
        else if (guess < 25) {
